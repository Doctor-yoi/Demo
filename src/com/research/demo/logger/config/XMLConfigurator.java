...
import com.research.demo.logger.DemoLogger;
import com.research.demo.logger.LoggerContext;
import com.research.demo.logger.appender.Appender;
import com.research.demo.logger.appender.AppenderAttachableImpl;
import com.research.demo.logger.appender.AppenderBase;
import com.research.demo.logger.filter.Filter;
import com.research.demo.logger.layout.Layout;
import com.research.demo.logger.util.ReflectionUtils;
import com.research.demo.logger.util.StringUtils;
...
public class XMLConfigurator implements Configurator{
    ...
    private void parseLoggers(Element document) throws IllegalAccessException, ClassNotFoundException, InstantiationException {
        ...
        for (int i = 0; i < loggerNodeList.getLength(); i++) {
            DemoLogger logger = parseChildrenOfLoggerElement((Element) loggerNodeList.item(i));
    ...
    private void parseRoot(Element document) throws IllegalAccessException, ClassNotFoundException, InstantiationException {
        ...
        DemoLogger root = parseChildrenOfLoggerElement(rootEle);
        loggerContext.setRoot(root);
    }

    private DemoLogger parseChildrenOfLoggerElement(Element element) throws InstantiationException, IllegalAccessException, ClassNotFoundException {
